...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div class="card mb-4 mx-auto col-lg-8">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <a href="./product_show.php">
              <h6 class="m-0 font-weight-bold text-success">See Product Table</h6>
            </a>
          </div>
        </div>
      </div>
      <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group mt-4">
          <label for="inputEmail3" class="col-form-label">Select Brand:</label>
          ...
          <select id="inputState" name="b_id" class="form-control">
            ...
            ?>
              <option value="<?php echo $rows['id'] ?>"><?php echo $rows['brand_name'] ?>
              </option>;
            <?php } ?>
        ...
        <div class="form-group">
          <label for="inputEmail3" class="col-form-label">Select Sub Category :</label>

          <select id="inputState" name="s_c_id" class="form-control">
            <?php
            $sql = "select * from sub_cateory";
            $result = mysqli_query($con, $sql);
            while ($rows = mysqli_fetch_assoc($result)) {
            ?>
              <option value="<?php echo $rows['id'] ?>"><?php echo $rows['sub_category_name'] ?>
              </option>;
            <?php } ?>
        ...
        <div class="form-group">
          ...
          <input type="text" name="product" class="form-control" id="inputEmail3">

        </div>

        <div class="form-group">
          <label for="inputEmail3" class="col-form-label">Product Description :</label>

          <input type="text" name="description" class="form-control" id="inputEmail3">

        </div>
        <div class="form-group">
          <label for="inputEmail3" class="col-form-label">Product Price :</label>
        ...
        <button type="submit" name="submit" class="btn btn-primary mb-3">Add Product</button>
      </form>
    </div>
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql = "insert into product (brand_id_FK , sub_category_id_FK , product_name , description , price , product_image) values ('$brand', '$sub', '$product', '$description', '$price', '$image')";
