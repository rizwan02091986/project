    ...
    <div class="card mb-4 mx-auto col-lg-8">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <a href="./user_show.php">
              <h6 class="m-0 font-weight-bold text-success">See User Table</h6>
            </a>
          </div>
        </div>
      </div>
      <form action="" method="post">
        <div class="row mb-3 mt-4">
          <label for="inputEmail3" class="col-sm-2 col-form-label">Select Role :</label>
          <div class="col-sm-10">
            <select id="inputState" name="r_id" class="form-control">
              <?php
        ...
        <button type="submit" name="submit" class="btn btn-primary mb-3">Add User</button>
      </form>
    </div>
...
if (isset($_POST['submit'])) {
  ...
  $sql = "insert into user (role_id_FK , username , email , password) values ('$role_id' , '$username' , '$email' , '$password')";
  $result = mysqli_query($con, $sql);
